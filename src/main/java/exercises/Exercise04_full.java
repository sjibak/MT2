...
public class Exercise04_full {
    public static void main(String[] args) {
        ...
        System.out.println("original image: " + image.width() + ", " + image.height());
        System.out.println("average image: " + averageImage.width() + ", " + averageImage.height());
